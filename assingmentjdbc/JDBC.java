...
public class JDBC {
	public static void main(String[] args) {
			...
			public static void insert() {
				...
				String query3 = "insert into employee values(3,'Stef','sk@gl.com',1566549871)";
			...
			public static void Modify() {
		        ...
		        String querry="alter table employee modify email varchar(30) not null";
			...
			public static void update() {
		        ...
		        String querry2="update employee set email='Karthik@gl' where Id=3";
		        try {
					Connection con =DriverManager.getConnection(url,username,password);
					Statement st=con.createStatement();
					int row=st.executeUpdate(querry);
